...
/* Double Robust Diff-in-Diff */
logit D0_did i.sexe i.milieu i.religion taille_menage
cap drop pihat
predict pihat
cap drop invwt
generate invwt=D0_did/pihat + (1-D0_did)/(1-pihat)
 
histogram pihat, by(D0_did)
regress nombre_éducation D0_did [pweight=invwt]
regress nombre_éducation i.sexe i.milieu i.religion taille_menage if D0_did==1
predict mu1
regress nombre_éducation i.sexe i.milieu i.religion taille_menage if D0_did==0
predict mu0

generate mdiff1=(-(D0_did-pihat)*mu1/pihat)-((D0_did-pihat)*mu0/(1-pihat))
generate iptw=(2*D0_did-1)*nombre_éducation*invwt
generate dr1=iptw+mdiff1
summarize dr1

scalar define dr_est=r(mean) 
***dr_est est l'estimateur robuste**
tempvar I dr_var
generate I=dr-dr_est
generate Isquared=I^2
summarize Isquared
